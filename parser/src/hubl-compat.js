function installCompat(env) {
  "use strict";
  /* eslint-disable camelcase */
  // This is a custom implementation of the installJinjaCompat function
  // with support for Hubl's custom syntax

  // env references the instance of nunjucks
  var runtime = env.runtime;
  var lib = env.lib;
  // Handle slim case where these 'modules' are excluded from the built source
  var Compiler = env.compiler.Compiler;
